...
from core.base_models import AuditableModel
from core.custom_fileds import UpperCaseCharField
...
class ProductAttributeClass(models.Model):
...
class Product(AuditableModel):
    ...
    attributes = models.ManyToManyField(ProductAttributeClass, through='ProductAttributeValue')
...
class ProductAttributeValue(models.Model):
    ...
    attribute = models.ForeignKey(ProductAttributeClass, on_delete=models.CASCADE)
