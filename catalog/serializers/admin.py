...
class CreateCategoryNodeSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        if parent is None:
            ...
            parentNode = get_object_or_404(Category, pk=parent)
            instance = parentNode.add_child(**validated_data)

        return instance

    class Meta:
        model = Category
        fields = ('id', 'title', 'description', 'visibility', 'slug', 'parent')
...
class CategoryTreeSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Category
        fields = ('id', 'title', 'description', 'visibility', 'slug', 'children')
